...
<p align="center">
  <img src="docs/cyd_remote.jpg" alt="CYD Touch Remote" width="400"/>
</p>

## ✨ Features

- 🎧 **Dual Connection Friendly:** Connects to your phone as a BLE HID Media Remote while your phone stays simultaneously connected to your Bluetooth Headphones / Earbuds / Speakers as normal!
...
1. Clone this repository:
   ```bash
   git clone https://github.com/DangCongKhanh2k4/esp32-cyd-music-controller.git
   cd esp32-cyd-music-controller
   ```
...
4. Play music on your Bluetooth Headphones or Speakers as usual!
